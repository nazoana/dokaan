...
import model.AccountsReceivable;
import model.Currency;
import model.Customer;
import model.OrderFromCustomer;
import model.OrderItemFromCustomer;
import model.OrderItemToSupplier;
import model.OrderToSupplier;
import model.PaymentFrequency;
import model.PaymentMethod;
import model.Product;
import model.ProductWarehouse;
import model.Supplier;
import model.Warehouse;
import model.WarehouseIn;
import model.WarehouseOut;
...
public class Persistence {
    ...
    private boolean createDatabase() {
        ...
        classNames.add(Currency.class.getName());
        classNames.add(OrderToSupplier.class.getName());
        classNames.add(OrderItemToSupplier.class.getName());
        classNames.add(OrderFromCustomer.class.getName());
        classNames.add(OrderItemFromCustomer.class.getName());
        classNames.add(PaymentMethod.class.getName());
        classNames.add(PaymentFrequency.class.getName());
        classNames.add(AccountsReceivable.class.getName());
        classNames.add(AccountsPayable.class.getName());
        classNames.add(Warehouse.class.getName());
        classNames.add(WarehouseIn.class.getName());
        classNames.add(WarehouseOut.class.getName());
        classNames.add(ProductWarehouse.class.getName());
        try {
